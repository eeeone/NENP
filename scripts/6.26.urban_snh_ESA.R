...
location <- read.csv("data/data_extraction/urban_coordinates.csv")
location$trt <- as.character(location$trt)
tif1 <- rast("data/data_extraction/urban_snh_extraction/ESA_WorldCover_10m_2020_v100_N48W006_Map.tif")
tif2 <- rast("data/data_extraction/urban_snh_extraction/ESA_WorldCover_10m_2020_v100_N27W084_Map.tif")
tif3 <- rast("data/data_extraction/urban_snh_extraction/ESA_WorldCover_10m_2020_v100_N42W084_Map.tif")
tif4 <- rast("data/data_extraction/urban_snh_extraction/ESA_WorldCover_10m_2020_v100_N54W006_Map.tif")
...
summarise_snh_radius <- function(buffer_radius) {
  ...
  N48W006_snh <- extract_snh("N48W006", location, tif1, buffer_radius = buffer_radius)
  N27W084_snh <- extract_snh("N27W084", location, tif2, buffer_radius = buffer_radius)
  N42W084_snh <- extract_snh("N42W084", location, tif3, buffer_radius = buffer_radius)
  N54W006_snh <- extract_snh("N54W006", location, tif4, buffer_radius = buffer_radius)
